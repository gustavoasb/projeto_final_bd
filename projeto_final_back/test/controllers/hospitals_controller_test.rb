...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { abbreviation: @hospital.abbreviation, name: @hospital.name } }, as: :json
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { abbreviation: @hospital.abbreviation, name: @hospital.name } }, as: :json
    assert_response 200
  end
